<?php
	...
	class Users extends Controller {
		public function __construct() {
			...
			$this->select->text('title', __('Список пользователей'));

			$this->browse = new Browse($this);
			$this->browse->text('title', __('Просмотр пользователя'));
			...
			$this->create->text('title', __('Добавление пользователя'));
			$this->create->text('btn', 'Добавить');
			$this->create->text('responseOk', __('Пользователь добавлен'));
			...
			$this->update->text('title', __('Изменение пользователя'));
			$this->update->text('btn', 'Изменить');
			$this->update->text('responseOk', __('Пользователь изменён'));

			$this->delete = new Delete($this);
			$this->delete->text('confirm', 'Удалить пользователя?');
			$this->delete->text('responseOk', __('Пользователь удалён'));
		}
