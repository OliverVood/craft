<div class = "view craft model create">
	...
	<form action = "<?= linkRight('craft_run')->path(['entity' => 'model', 'action' => 'create']); ?>">
		...
		<?= componentSolution()->checkbox(__('Использовать базу данных'), ['name' => 'params[model]', 'value' => '', 'class' => 'm-t-24', 'onchange' => /** @lang JavaScript */ "globalThis.Craft.Controller.addDatabaseForModel(this);"]); ?>
