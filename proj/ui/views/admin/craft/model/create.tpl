<div class = "view craft model create">
	...
	<form action = "<?= linkRight('craft_run')->path(['entity' => 'model', 'action' => 'create']); ?>">
		...
		<?= componentSolution()->checkbox(__('Использовать базу данных'), ['name' => 'params[model]', 'value' => '', 'onchange' => /** @lang JavaScript */ "Base.Craft.Controller.addDatabaseForModel(this);"]); ?>
